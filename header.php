				...
				<header id="header">
					...
					<?php if ( has_nav_menu('mobile') ): ?>
						<div id="wrap-nav-mobile" class="wrap-nav">
							<?php \Boxstyle\Nav::nav_menu(array('theme_location'=>'mobile','menu_id' => 'nav-mobile','fallback_cb'=> false)); ?>
					...
					<div id="header-sticky">
						<?php if ( has_nav_menu('header') ): ?>
							<div id="wrap-nav-header" class="wrap-nav">
								<?php \Boxstyle\Nav::nav_menu(array('theme_location'=>'header','menu_id' => 'nav-header','fallback_cb'=> false)); ?>
